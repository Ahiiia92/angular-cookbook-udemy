...
export class AuthService {
  ...
  signup(email: string, password: string) {
    ...
    return this.http.post<AuthResponseData>('https://www.googleapis.com/identitytoolkit/v3/relyingparty/signupNewUser?key=AIzaSyAvvCUg_qtwG-2RoNmVDK_kDvdfVBisWWY',
      {
        email: email,
        password: password,
  ...
  login(email: string, password: string) {
    return this.http.post<AuthResponseData>('https://www.googleapis.com/identitytoolkit/v3/relyingparty/verifyPassword?key=AIzaSyAvvCUg_qtwG-2RoNmVDK_kDvdfVBisWWY',
      {
        email: email,
        password: password,
        returnSecureToken: true
